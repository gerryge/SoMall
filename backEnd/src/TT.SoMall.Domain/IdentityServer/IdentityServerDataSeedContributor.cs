...
namespace TT.SoMall.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            //Web Client
            var webClientId = configurationSection["SoMall_Web:ClientId"];
            if (!webClientId.IsNullOrWhiteSpace())
            {
                var webClientRootUrl = configurationSection["SoMall_Web:RootUrl"].EnsureEndsWith('/');

                /* SoMall_Web client is only needed if you created a tiered
